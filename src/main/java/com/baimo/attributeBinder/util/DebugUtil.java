...
public class DebugUtil {
    ...
    public DebugUtil(Plugin plugin, LogLevel level) {
        ...
        // 前缀示例：[YourPluginName]
        this.prefix = ChatColor.translateAlternateColorCodes('&', "&f[&a" + plugin.getName() + "&f]&r ");
    ...
    public void log(LogLevel level, String message) {
        ...
        switch (level) {
            case DEBUG:
                ...
                logger.log(Level.INFO, ChatColor.GRAY + "[DEBUG] " + message);
                break;
            case INFO:
    ...
    public void log(LogLevel level, String message, Throwable t) {
        ...
        switch (level) {
            case DEBUG:
                logger.log(Level.INFO, ChatColor.GRAY + "[DEBUG] " + message, t);
                break;
            case INFO:
