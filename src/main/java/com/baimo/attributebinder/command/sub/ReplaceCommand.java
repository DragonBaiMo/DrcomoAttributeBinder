...
public class ReplaceCommand {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        CommandUtil.OptParams params = CommandUtil.parseReplaceParams(args, sender);
        ...
        if (Double.compare(oldVal, vp.value) == 0) {
            ...
            CommandUtil.sendReplaceSuccess(sender, target.getName(), stat, valStr, params.keyId);
        } else {
            ...
            String valStr = CommandUtil.formatValue(vp.value, vp.percent);
            CommandUtil.sendReplaceSuccess(sender, target.getName(), stat, valStr, params.keyId);
        }
    }
}
